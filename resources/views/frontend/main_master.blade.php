...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href="{{ asset('frontend') }}/assets/
...
<script src="{{ asset('frontend') }}/assets/
...
<script src="{{ asset('frontend') }}/assets/
js/bootstrap-slider.min.js"></script> 
<script src="{{ asset('frontend') }}/assets/
js/jquery.rateit.min.js"></script> 
<script type="text/javascript" src="{{ asset('frontend') }}/assets/
